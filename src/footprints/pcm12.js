module.exports = {
  ...
  body: (p) => {
    const standard = `
        ...
        (fp_text user %R (at 0 -3.2) (layer F.Fab) (effects (font (size 1 1) (thickness 0.15))))

        (pad "" thru_hole circle (at 0 -3) (size 0.6 0.6) (drill 0.3) (layers *.Cu *.Mask) ${
          p.from.str
        })
    ...
    function pins(def_neg, def_pos, def_side) {
      return `
        ...
        (pad "" np_thru_hole circle (at 1.5 0.33) (size 0.9 0.9) (drill 0.9) (layers *.Cu *.Mask))
        (pad 1 smd rect (at ${def_neg}2.25 -1.43) (size 0.7 1.5) (layers ${def_side}.Cu ${def_side}.Paste ${def_side}.Mask) ${
          p.from.str
        })
        (pad 2 smd rect (at ${def_pos}0.75 -1.43) (size 0.7 1.5) (layers ${def_side}.Cu ${def_side}.Paste ${def_side}.Mask) ${
          p.to.str
        })
